...
export const Route = createFileRoute("/employer-services")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Overseas Manpower & Trade Testing | Dhamodaran Immigration" },
      {
        property: "og:description",
        content:
          "SLA-backed bulk hiring, certified trade testing workshops, GAMCA medicals, eMigrate processing and 90-day replacement guarantees.",
      },
    ],
  }),
