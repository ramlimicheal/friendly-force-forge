...
export const Route = createFileRoute("/destinations/schengen-europe")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "European Work Permits & Recruitment | Dhamodaran Immigration" },
      {
...
const europeProcessSteps = [
  ...
  },
  {
    ...
    desc: "Government authorities issue the original stamped Work Permit approval document, sent securely to our Chennai documentation desk.",
  },
  {
    num: "03",
