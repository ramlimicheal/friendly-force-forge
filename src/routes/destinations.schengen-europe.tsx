...
const priorityDestinations = [
  {
    ...
    lead: "3 – 6 Months",
    desc: "Our premier flagship destination offering world-class quality of life, high wage standards, and direct PR pathways. We handle 6-point SMC assessments, Accredited Employer job matching, and straight-to-residence Green List filings.",
    roles: [
