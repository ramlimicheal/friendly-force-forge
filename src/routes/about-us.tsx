  ...
  head: () => ({
    meta: [
      { title: "About Us | 20+ Years MEA-Licensed Overseas Recruitment Heritage" },
      {
        name: "description",
        content:
          "Learn about Dhamodaran Immigration (MEA Lic. B-0824/TN/PER/1000+/5/9821/2021). Over two decades of ethical overseas recruitment, trade testing, and global mobilization across 24+ countries.",
      },
      { property: "og:title", content: "About Us | Dhamodaran Immigration" },
      {
        property: "og:description",
        content:
          "Two decades of landmark growth in overseas recruitment, accredited trade testing, and statutory MEA compliance from Chennai, India.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "AboutPage",
          "name": "About Dhamodaran Immigration",
          "url": "https://dhamodaranimmigration.com/about-us",
          "description": "Comprehensive history, licensing credentials, and operational standards of Dhamodaran Immigration.",
          "breadcrumb": {
            "@type": "BreadcrumbList",
            "itemListElement": [
...
const quickStats = [
  { value: "20+", label: "Years of Heritage", sub: "Founded in 2004 in Tamil Nadu" },
      ...
      <Section eyebrow="Heritage & Authority" title="From a regional trade desk to a 24-country bridge">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_1fr] items-center">
          <div className="space-y-5 text-muted-foreground text-sm sm:text-base leading-relaxed">
            <p>
              Dhamodaran Immigration & Overseas Manpower Consultancy began in 2004 with a singular principle:
