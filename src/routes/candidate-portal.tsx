...
export const Route = createFileRoute("/candidate-portal")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Candidate Career Portal | Dhamodaran Immigration" },
      {
...
const candidateSteps = [
  ...
  },
  {
    ...
    desc: "Attend our pre-departure cultural and safety orientation in Chennai, receive your flight ticket, and get received by your employer's HR team abroad.",
  },
];
...
const safetyPillars = [
  {
    ...
    desc: "Dhamodaran Immigration operates strictly from our registered headquarters in Chennai. We have NOT authorized any roaming middlemen, WhatsApp brokers, or village agents to collect cash.",
  },
  {
    icon: FileText,
    title: "Inspect Your Written Contract",
    desc: "Never travel on a tourist visa for employment. Every legal job through Dhamodaran comes with a verified work visa and an official MEA eMigrate employment agreement.",
  },
  {
    icon: AlertTriangle,
  ...
  return (
    <>
      ...
      <Section
        ...
        intro="Dhamodaran Immigration is committed to 100% legal, ethical recruitment under the Emigration Act 1983. Protect yourself from fraudulent travel agents."
      >
      ...
      <Section
        ...
        intro="Register once in our verified candidate pool. When a matching employer demand opens, our Chennai desk contacts you directly with written terms."
      >
        <FadeIn direction="up">
