...
export const Route = createFileRoute("/destinations/usa-visa")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "USA Employment Visas & Green Card | Dhamodaran Immigration" },
      {
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
              <p className="font-semibold text-brand-deep">
                Dhamodaran Immigration acts strictly as a recruitment consultancy and credential evaluator.
              </p>
              <p>
